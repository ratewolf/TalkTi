...
## 역할 기반 패키지 분리 (4인 병렬 개발)

프로젝트는 병렬 개발을 위해 역할 기반 패키지 경계를 추가했습니다. 상세 규칙은 `GUIDE.md`를 참고하세요.

- 앱 파트: `composeApp/.../kr/ac/kopo/talkti/app/**`
- 데이터 파트: `shared/.../kr/ac/kopo/talkti/data/**`
- 백엔드 파트: `server/.../kr/ac/kopo/talkti/backend/**`
- LLM 파트: `shared/.../kr/ac/kopo/talkti/llm/**`
