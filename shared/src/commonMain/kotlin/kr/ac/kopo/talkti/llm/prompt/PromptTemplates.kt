...
object PromptTemplates {
    ...
    const val SCREEN_ANALYZE_SYSTEM_PROMPT = """
        ...
        - 장소 검색 결과 화면에서 상단의 필터 탭(예: "전체", "장소", "버스", "지하철", "MY" 등)은 절대 클릭하거나 선택하지 마세요. 사용자의 실제 목적지는 검색된 장소 목록(리스트) 영역에서 선택해야 합니다. 현재 대화에 "버스" 등의 교통 수단 키워드가 있더라도, 절대 상단의 "버스" 필터 탭을 눌러서는 안 되며 장소 목록 가이드(`actionType: GUIDE`)에 집중해야 합니다.
